...
#
# Created: Sun Mar 08 23:34:53 2015
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ArrayButton = QtGui.QPushButton(Form)
        self.ArrayButton.setGeometry(QtCore.QRect(700, 30, 41, 41))
        self.ArrayButton.setObjectName(_fromUtf8("ArrayButton"))
        self.HandButton = QtGui.QPushButton(Form)
        self.HandButton.setGeometry(QtCore.QRect(700, 80, 41, 41))
        self.HandButton.setObjectName(_fromUtf8("HandButton"))
        self.ZoomButton = QtGui.QPushButton(Form)
        self.ZoomButton.setGeometry(QtCore.QRect(700, 130, 41, 41))
        self.ZoomButton.setObjectName(_fromUtf8("ZoomButton"))
        self.label_5 = QtGui.QLabel(Form)
        self.label_5.setGeometry(QtCore.QRect(650, 340, 54, 12))
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.TextBrowser = QtGui.QTextBrowser(Form)
        self.TextBrowser.setGeometry(QtCore.QRect(650, 359, 341, 231))
        self.TextBrowser.setObjectName(_fromUtf8("TextBrowser"))
        self.label_12 = QtGui.QLabel(Form)
        self.label_12.setGeometry(QtCore.QRect(770, 30, 54, 12))
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.verticalLayoutWidget_2 = QtGui.QWidget(Form)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(830, 30, 161, 161))
        self.verticalLayoutWidget_2.setObjectName(_fromUtf8("verticalLayoutWidget_2"))
        self.PreLayout = QtGui.QVBoxLayout(self.verticalLayoutWidget_2)
        self.PreLayout.setMargin(0)
        self.PreLayout.setObjectName(_fromUtf8("PreLayout"))
        self.label_13 = QtGui.QLabel(Form)
        self.label_13.setGeometry(QtCore.QRect(700, 200, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.layoutWidget = QtGui.QWidget(Form)
        self.layoutWidget.setGeometry(QtCore.QRect(770, 200, 221, 154))
        ...
        self.label_21.setGeometry(QtCore.QRect(750, 130, 54, 12))
        self.label_21.setObjectName(_fromUtf8("label_21"))
        self.ZoomLabel = QtGui.QLabel(Form)
        self.ZoomLabel.setGeometry(QtCore.QRect(760, 150, 54, 12))
        self.ZoomLabel.setObjectName(_fromUtf8("ZoomLabel"))
        self.LengthLabel = QtGui.QLabel(Form)
        self.LengthLabel.setGeometry(QtCore.QRect(900, 10, 54, 12))
        self.LengthLabel.setObjectName(_fromUtf8("LengthLabel"))
        self.label_3 = QtGui.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(840, 10, 54, 12))
        ...
        self.SaveAsButton.setGeometry(QtCore.QRect(280, 0, 75, 23))
...
"交叉", None))
        ...
        self.ArrayButton.setText(_translate("Form", "指针", None))
        self.HandButton.setText(_translate("Form", "手", None))
        self.ZoomButton.setText(_translate("Form", "缩放", None))
        self.label_5.setText(_translate("Form", "赛道元素：", None))
        self.label_12.setText(_translate("Form", "赛道预览：", None))
