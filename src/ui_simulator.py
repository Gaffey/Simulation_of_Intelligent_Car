...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.AccelerateEdit.setReadOnly(True)
        ...
        self.CoordinateEdit.setReadOnly(True)
        ...
        self.CameraLayout = QtGui.QVBoxLayout(self.verticalLayoutWidget_2)
        self.CameraLayout.setObjectName(_fromUtf8("CameraLayout"))
        self.label_6 = QtGui.QLabel(Form)
        self.label_6.setGeometry(QtCore.QRect(630, 50, 91, 21))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.StepEdit = QtGui.QLineEdit(Form)
        self.StepEdit.setGeometry(QtCore.QRect(720, 50, 71, 20))
        ...
        self.LoadAIButton = QtGui.QPushButton(Form)
        self.LoadAIButton.setGeometry(QtCore.QRect(190, 10, 75, 23))
        self.LoadAIButton.setObjectName(_fromUtf8("LoadAIButton"))
    ...
    def retranslateUi(self, Form):
        ...
        self.StepEdit.setText(_translate("Form", "10", None))
        ...
        self.LoadAIButton.setText(_translate("Form", "加载ai", None))
